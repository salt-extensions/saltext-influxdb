...
def tests(session):
    ...
    try:
        ...
        session.run(
            ...
            "--omit=src/saltext/influxdb/*",
            "--include=tests/*",
        )
        try:
            session.run("coverage", "report", "--show-missing", "--include=src/saltext/influxdb/*")
            ...
            #    "--include=src/saltext/influxdb/*,tests/*"
            # )
        finally:
